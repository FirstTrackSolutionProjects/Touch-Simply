...
const NavBar = () => {
  ...
  return (
    <>
      {/* Navbar */}
      <nav className="w-full bg-gradient-to-r from-indigo-700 via-purple-950 to-gray-950 backdrop-blur-md shadow-sm sticky top-0 z-50">
       ...
       {/* Menu Items */}
        <div className="flex flex-col p-6 gap-6 text-gray-300 font-medium">
          ...
          <Link
            onClick={() => setMenuOpen(false)}
            to="/login"
            className="flex items-center justify-center gap-2 bg-gradient-to-r from-purple-600 to-indigo-600 text-white px-4 py-2 rounded-lg mt-4 hover:opacity-90 transition"
          >
            <FaSignInAlt />
            Login
          </Link>
